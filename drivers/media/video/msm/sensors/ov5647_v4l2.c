...
/* this setting is the same as ov5647_snap_settings_flip */
static struct msm_camera_i2c_reg_conf ov5647_zsl_settings_flip[] = {
/*2608*1952 Reference Setting 24M MCLK 2lane 280Mbps/lane 30fps*/
    {0x3035, 0x21},
    {0x3036, 0x66},
    {0x303c, 0x11},
...
static struct msm_camera_i2c_conf_array ov5647_confs_flip[] = {
	...
	{&ov5647_video_90fps_settings[0],
	ARRAY_SIZE(ov5647_video_90fps_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&ov5647_zsl_settings_flip[0],
	ARRAY_SIZE(ov5647_zsl_settings_flip), 0, MSM_CAMERA_I2C_BYTE_DATA},
};
